		...
		if (dealNo == "") {
			...
			$.ajax({
					...
					success : function(data) {
						...
						var searchCountInfoDiv = document
								.getElementById("searchCountInfo");
						if (data != "notfound") {
							...
							for (var i = 0; i < resultStr.length; i++) {
								...
								if (resultStr[i].bankno != undefined
									...
									contentStr = contentStr
											...
											+ resultStr[i].businesstype
											+ "</td>" + "<td width='40px'>"
											+ resultStr[i].fromSource
											+ "</td>" + "</tr>"
								}
								if (resultStr[i].countNum == 0) {
									contentCountStr = contentCountStr
											+ "<tr align='middle'>"
											+ "<td width='230px'>"
											+ resultStr[i].localBankName
											+ "</td>"
											+ "<td width='200px'>"
											+ resultStr[i].countNum
											+ "</td>"
								...
								if (banknoList
										.indexOf(resultStr[i].localBankName) == -1) {
									banknoList = banknoList
											+ resultStr[i].localBankName;
									contentCountStr = contentCountStr
											+ "<tr align='middle'>"
											+ "<td width='230px'>"
							...
							if (contentStr == "") {
								...
								searchCountInfoDiv.innerHTML = "<div style='border:1px solid #9db3c5;width:90%;height:300px;overflow-x:hidden;overflow-y:scroll' id='contentDiv2'><table class='t2'  id='contentValue2'>"
										...
										+ "</tr>"
										+ "<table></div>";
								var contentDiv2 = document
										.getElementById("contentDiv2");
...
<body>
	...
	<div
		...
		<div style="padding-top: 15px;">
			<h1>
				<font size="6" color="#FFFFFF" face="华文楷体">&nbsp;南宁中心支行&nbsp;</font><font
					size="4" color="#FFFFFF" face="华文楷体">人民币冠字号码查询信息管理系统欢迎您</font>
			</h1>
		</div>
		<form action="GZHQueryServlet" id="form" name="form" method="post"
