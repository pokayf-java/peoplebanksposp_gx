...
public class MoneyDataInfo {
	...
	private Integer fromSource;		//查询来源  1：人行、2：商行
	private Integer causeInfo;		//原因	1：网络连接异常、2：连接超时   3：库中未查询到相关记录		
	private Integer countNum;		//统计记录数
	private String localBankName;	//统计银行名称
	/*显示*/
	...
	public Integer getCauseInfo() {
		return causeInfo;
	}



	public void setCauseInfo(Integer causeInfo) {
